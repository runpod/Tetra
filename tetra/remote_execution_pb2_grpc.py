...
import tetra.remote_execution_pb2 as remote__execution__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in remote_execution_pb2_grpc.py depends on'
...
def add_RemoteExecutorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecuteFunction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=remote__execution__pb2.FunctionRequest.FromString,
                    response_serializer=remote__execution__pb2.FunctionResponse.SerializeToString,
            ),
    }
